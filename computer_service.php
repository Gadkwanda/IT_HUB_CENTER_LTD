...
<?php include 'includes\computerheadline.php'; ?>  

<div class="row">    
        <div class="column middle">
  <section class="preview-section">

    <!--<h3 class="tagline">All about Computer services</h3>-->
    
<img src="assest\download\commputer\hardwar12.png" alt="Project 2" />
    <div class="preview-grid">

      <div class="preview-card">

        <img src="assest\download\commputer\computer-service-banner-1.jpg" alt="Project 3" />
      ...
      <div class="preview-card">
        <img src="assest\download\commputer\1520152680610.jpeg" alt="Project 2" />
        <div class="preview-overlay">
...
<div class="preview-card">
        <img src="assest\download\commputer\Screenshot_20250503-094935.jpg" alt="Project 2" />
        <div class="preview-overlay">
          <h3>E-Commerce Platform</h3>
          <a href="project2-details.html" class="preview-link" target="_blank">View Study</a>
        </div>
      ...
      <div class="preview-card">
        <img src="assest\download\commputer\65-653452_laptop-and-desktop-repair-hd-png-download.png" alt="Project 1" />
        <div class="preview-overlay">
          <h3>Mobile App UI</h3>
...
<img src="assest\download\commputer\Screenshot_20250503-100900.jpg" alt="Project 2" />
    </div>
