...
<?php include 'includes\house_wiringhealdine.php'; ?>  
...
<div class="row">    
  ...
  <section class="preview-section">
    ...
    <h3 class="tagline">All about House electric wiring services</h3>
    <div class="preview-grid">

      <div class="preview-card">
        <img src="assest\download\house wiring\house-electrical-fitting-service-500x500.jpg" alt="Project 1" />
      ...
      <div class="preview-card">
        <img src="assest\download\house wiring\house_wiring2.jpg" alt="Project 2" />
        <div class="preview-overlay">
...
<div class="preview-card">
        <img src="assest\download\house wiring\house-wiring.png" alt="Project 2" />
        <div class="preview-overlay">
          <h3>E-Commerce Platform</h3>
          <a href="project2-details.html" class="preview-link" target="_blank">View Study</a>
        </div>
      ...
      <div class="preview-card">
        <img src="assest\download\1668283211649.jpeg" alt="Project 3" />
        <div class="preview-overlay">
          <h3>Mobile App UI</h3>
...
<?php //include 'includes\pricing.php'; ?> 
    ...
    <img src="assest\download\house wiring\Screenshot_20250503-093448.jpg" alt="Project 3" />
      <!--<form class="form">
